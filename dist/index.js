...
define("@scom/scom-token-list/tokens/mainnet/index.ts", ["require", "exports", "@scom/scom-token-list/tokens/mainnet/avalanche.ts", "@scom/scom-token-list/tokens/mainnet/ethereum.ts", "@scom/scom-token-list/tokens/mainnet/polygon.ts", "@scom/scom-token-list/tokens/mainnet/bsc.ts", "@scom/scom-token-list/tokens/mainnet/fantom.ts", "@scom/scom-token-list/tokens/mainnet/cronos.ts"], function (require, exports, avalanche_1, ethereum_1, polygon_1, bsc_1, fantom_1, cronos_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("@scom/scom-token-list/tokens/testnet/kovan.ts", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("@scom/scom-token-list/tokens/testnet/index.ts", ["require", "exports", "@scom/scom-token-list/tokens/testnet/kovan.ts", "@scom/scom-token-list/tokens/testnet/bsc-testnet.ts", "@scom/scom-token-list/tokens/testnet/fuji.ts", "@scom/scom-token-list/tokens/testnet/mumbai.ts", "@scom/scom-token-list/tokens/testnet/fantom-testnet.ts", "@scom/scom-token-list/tokens/testnet/amino.ts", "@scom/scom-token-list/tokens/testnet/aminoX-testnet.ts", "@scom/scom-token-list/tokens/testnet/cronos-testnet.ts"], function (require, exports, kovan_1, bsc_testnet_1, fuji_1, mumbai_1, fantom_testnet_1, amino_1, aminoX_testnet_1, cronos_testnet_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("@scom/scom-token-list/tokens/index.ts", ["require", "exports", "@scom/scom-token-list/tokens/mainnet/index.ts", "@scom/scom-token-list/tokens/testnet/index.ts"], function (require, exports, index_1, index_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.CoreContractAddressesByChainId = exports.DefaultTokens = exports.ChainNativeTokenByChainId = exports.DefaultERC20Tokens = void 0;
    ...
    exports.CoreContractAddressesByChainId = CoreContractAddressesByChainId;
});
define("@scom/scom-token-list/utils.ts", ["require", "exports", "@ijstech/eth-wallet", "@scom/scom-token-list/interface.ts", "@scom/scom-token-list/tokens/index.ts"], function (require, exports, eth_wallet_1, interface_1, index_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.addUserTokens = exports.getChainNativeToken = exports.getGovToken = exports.getAddresses = exports.getUserTokens = exports.getDefaultChainId = exports.getSiteEnv = exports.setSiteEnv = exports.hasUserToken = exports.setUserTokens = exports.hasMetaMask = exports.getChainId = exports.isWalletConnected = exports.state = exports.WalletPlugin = void 0;
    ...
    exports.state = {
        currentChainId: 0,
        userTokens: {},
        siteEnv: interface_1.SITE_ENV.TESTNET
    };
    ...
    const setSiteEnv = (value) => {
        if (Object.values(interface_1.SITE_ENV).includes(value)) {
            exports.state.siteEnv = value;
        }
        else {
            exports.state.siteEnv = interface_1.SITE_ENV.TESTNET;
        }
    };
    ...
    const getDefaultChainId = () => {
        switch (exports.getSiteEnv()) {
            case interface_1.SITE_ENV.TESTNET:
                return 97;
            case interface_1.SITE_ENV.DEV:
            case interface_1.SITE_ENV.MAINNET:
            default:
                return 56;
        }
    };
    ...
    const getChainNativeToken = (chainId) => {
        return index_3.ChainNativeTokenByChainId[chainId];
    };
    exports.getChainNativeToken = getChainNativeToken;
    const addUserTokens = (token) => {
        const chainId = exports.getChainId();
        let tokens = localStorage[TOKENS + chainId];
        let i = -1;
        if (tokens) {
            tokens = JSON.parse(tokens);
    ...
    class TokenStore {
        ...
        _updateTokenMapData(chainId) {
            ...
            if (this._defaultTokensByChain[chainId]) {
                ...
                this._projectToken = stakeToken ? Object.assign(Object.assign({}, stakeToken), { address: stakeToken.address.toLowerCase() }) : null;
                if (GovTokenObj)
